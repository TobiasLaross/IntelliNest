...
enum EntityId: String, Decodable, CaseIterable {
    ...
    case sideDoorLock = "lock.side_door"
    case frontDoorLock = "lock.front_door"
    case storageLock = "lock.storage_st"
    ...
    case solarProductionToday = "sensor.solaredge_energy_today"
